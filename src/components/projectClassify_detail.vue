...
<img src="../assets/images/dhkicon.png" class="biaojiimg" />
        ...
        <div class="detail_right">
           ...
           <div class="dr2">
              <p>实际还款：<input class="money" name="moneyinput" v-model="inputvalue" readonly  /><span>元</span></p>
           </div>
           <div class="dr31">
                <a>
                 <img src="../assets/images/ljczbtn.png"/>
                   </a>
           </div>
           <div class="dr4">
               <p>温馨提示：</p>
...
<style lang="scss">
@import "../assets/css/projectClassify_detail.scss";
</style>
