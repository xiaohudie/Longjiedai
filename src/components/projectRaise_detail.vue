...
<img src="../assets/images/mjzicon.png" class="biaojiimg" />
        <div class="detail_left">
            <div class="dl1">
            <p class="BTleft">{{tenderName}}</p>
            <p class="Timeright" v-if="repayDate==0||repayDate==''||repayDate==null">还款时间：--</p>
            ...
            <ul class="dlul">
               ...
               <li>
                    <p class="li3_1 ulleft">发布时间&nbsp;&nbsp;{{saleTime | newFormatDate}}</p>
        ...
        <div class="detail_right">
           ...
           <div class="dr32">
                <a>
                 <img src="../assets/images/mjzbtn.png"/>
                   </a>
           </div>
           <div class="dr4">
               <p>温馨提示：</p>
  ...
  methods: {
      ...
      this.$api.get(
        ...
        function(res) { 
          ...
          detail.saleTime=res.data.saleTime;
...
<style lang="scss">
@import "../assets/css/projectRaise_detail.scss";
</style>
